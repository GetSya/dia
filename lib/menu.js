...
const ORDER = {
    ...
    'Group Menu': ['setppgc', 'mute', 'welcome', 'left', 'setwelcome', 'antilink', 'antimedia', 'antidelete', 'hidetag', 'tagall', 'kick', 'add', 'setname', 'setdesc', 'open', 'close', 'totag', 'promote', 'demote', 'igdl', 'tiktokmp3', 'play', 'ytmp3', 'ytmp4']
}
