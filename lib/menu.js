...
const FORCE_CAT = {
    ...
    'stalkig': 'Other Menu',
    'igdl': 'Download Menu',
    'tiktok': 'Download Menu',
    'tiktokmp3': 'Download Menu',
    'ytmp3': 'Download Menu',
    'ytmp4': 'Download Menu',
    'play': 'Download Menu',
    'antidelete': 'Group Menu',
    'antimedia': 'Group Menu',
...
const ORDER = {
    'Other Menu': ['quotes', 'pinterest', 'ppcp', 'tomp3', 'sholat', 'emojimix', 'delete', 'tourl', 'menfess', 'confess', 'sticker', 'stcmeme', 'stcmeme2', 'memegen', 'meme', 'bajingan', 'brat', 'toimg', 'ssweb', 'removebg', 'qc', 'remini', 'stalkig', 'take', 'tts',     'listprem', 'cekprem', 'chatbot', 'ai', 'aireset', 'aiusage', 'editimg', 'translate', 'google', 'qr', 'encode', 'decode', 'buyprem'],
    'Game Menu': ['tebakgambar', 'caklontong', 'tebakkata', 'siapakahaku', 'tebaklagu', 'tebakkimia', 'soal', 'tod', 'dadu', 'tictactoe'],
    'Economy Menu': ['uang', 'transfer', 'belipoin', 'jualpoin', 'harian', 'shop', 'transaksi', 'peringkat', 'ekonomi'],
    'Poin Menu': ['poin', 'top'],
    'Owner Menu': ['setpp', 'setexif', 'join', 'leave', 'addplugins', 'deleteplugins', 'public', 'self', 'create-token', 'block', 'unblock', 'blocklist', 'ban', 'unban', 'banlist', 'bangroup', 'unbangroup', 'backup', 'dbcount'],
    'Group Menu': ['setppgc', 'mute', 'welcome', 'left', 'setwelcome', 'antilink', 'antimedia', 'antidelete', 'hidetag', 'tagall', 'kick', 'add', 'setname', 'setdesc', 'open', 'close', 'totag', 'promote', 'demote'],
    'Download Menu': ['igdl', 'tiktok', 'tiktokmp3', 'play', 'ytmp3', 'ytmp4']
}

// Deskripsi per command (tanpa emoji, sesuai aturan menuku)
const DESC = {
    'sms': ' <Nomor|Pesan|Jumlah>', 'quotes': ' ', 'pinterest': ' _< Pencarian >_',
    'ppcp': '', 'tomp3': '', 'sholat': ' _< Nama Kota >_',
    ...
    'listprem': '', 'cekprem': '', 'chatbot': ' < on [--vn|--text]/off >', 'ai': ' < Text >', 'aireset': '', 'aiusage': '',
    'editimg': ' <prompt> (reply foto)', 'translate': ' < Reply Message >',
    'google': ' < Search >', 'qr': ' < Text >', 'encode': ' < Text >', 'decode': ' < Text >',
    'play': ' <judul lagu> [--vn|--video|--doc]', 'ytmp3': ' <link youtube>', 'ytmp4': ' <link youtube>',
    'tiktokmp3': ' <link tiktok>', 'tiktok': ' <link tiktok>', 'buyprem': '',
    'setpp': ' <Reply Image>', 'setexif': ' <PackName|Author>',
    'join': ' <WhatsApp Group Link>', 'leave': '', 'addplugins': '', 'deleteplugins': '',
    'public': '', 'self': '', 'create-token': '', 'block': ' <@user/628XXX>', 'unblock': ' <@user/628XXX>', 'blocklist': '',
    'ban': ' <@user/628XXX> [alasan]', 'unban': ' <@user/628XXX>', 'banlist': '', 'bangroup': ' [alasan]', 'unbangroup': '',
    'backup': '', 'dbcount': '',
    'setppgc': ' <Reply Image>', 'mute': '', 'welcome': ' <on/off>', 'left': ' <on/off>',
    'setwelcome': ' <teks (@user @group @date)>', 'antidelete': ' <on/off>',
    'antilink': ' <Enable/Disable>', 'antimedia': '', 'hidetag': ' <Text>', 'tagall': ' <Message>',
    ...
    'tictactoe': ' <bot|@tag|create|join>',
    'uang': '', 'transfer': ' @user <jumlah>', 'belipoin': ' <jumlah>', 'jualpoin': ' <jumlah>', 'harian': '', 'shop': ' [beli|cek|pesanan]', 'transaksi': ' [hal]', 'peringkat': ' [uang|poin] [hal]', 'ekonomi': ' <give|remove|set|setpoin|unlimited>'
}
...
function buildMenuSections(prefix) {
    ...
    const cats = ['Other Menu', 'Game Menu', 'Economy Menu', 'Poin Menu', 'Owner Menu', 'Group Menu', 'Download Menu']
    const byCat = {}
...
// Cache teks menu jadi (control.js memanggilnya tiap pesan).
// Kunci: ukuran + mtime control.js + prefix. statSync murah (tanpa baca file).
let _menuTextCache = null
function renderMenuSections(prefix) {
    let key = ''
    try {
        const st = fs.statSync(CONTROL_PATH)
        key = st.size + ':' + st.mtimeMs + ':' + prefix
    } catch {}
    if (_menuTextCache && _menuTextCache.key === key) return _menuTextCache.text
    const text = buildMenuSections(prefix).text
    _menuTextCache = { key, text }
    return text
}
