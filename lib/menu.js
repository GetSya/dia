...
const ORDER = {
    ...
    'Economy Menu': ['balance', 'transfer', 'buypoint', 'sellpoint', 'daily', 'shop', 'transactions', 'leaderboard', 'economy'],
    'Poin Menu': ['poin', 'top'],
    'Owner Menu': ['setpp', 'setexif', 'join', 'leave', 'addplugins', 'deleteplugins', 'public', 'self', 'create-token', 'block', 'unblock', 'blocklist', 'ban', 'unban', 'banlist', 'bangroup', 'unbangroup', 'resetpoin', 'backup', 'dbsync'],
...
const DESC = {
    ...
    'balance': '', 'transfer': ' @user <jumlah>', 'buypoint': ' <jumlah>', 'sellpoint': ' <jumlah>', 'daily': '', 'shop': ' [buy] [id] [qty]', 'transactions': ' [hal]', 'leaderboard': ' [money|point] [hal]', 'economy': ' <give|remove|set|setpoint>'
}
